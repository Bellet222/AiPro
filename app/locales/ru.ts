...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Для доступа к приложению,нажмите на кнопку в виде шестеренки, расположенную в левом нижнем углу,чтобы перейти в настройки. Затем найдите поле для ввода кода доступа и введите код из письма. Еще можно вставить --> [Вот Тут](/#/auth) Вы также можете обратиться в нашу службу поддержки в Telegram https://t.me/AiPro_support_bot.",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    Config: {
      ...
      SaveAs: "Сохранить как подсказку",
    },
  },
  Export: {
    Title: "Все сообщения",
  ...
  NewChat: {
    Return: "Вернуться",
    Skip: "Пропустить",
    Title: "Выберете подсказку",
    SubTitle: "Выберете подсказку для ваших нужд",
    More: "Найти еще",
